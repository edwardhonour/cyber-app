...
@Component({
  selector: 'app-threat-cons-template',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './threat-cons-template.component.html',
  styleUrls: ['./threat-cons-template.component.css']
})
export class ThreatConsTemplateComponent  implements OnInit {
  ...
  ngOnInit(): void {    
        setTimeout(() => {
                  ...
                  this._dataService.postForm("get-threat-cons", this.parameters).subscribe((data:any)=>{
                    this.data=data;
                  });
        }, 100);
      }
